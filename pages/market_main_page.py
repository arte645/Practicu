...
class MarketPage(Base):
    ...
    def add_to_cart(self, index):
        self.click_element_by_index(Market.ADD_TO_CART, index) #кликаем по индексу, 0 это значит, что кликаем по первой карточке
    ...
    def follow_to_basket(self):
        self.click(Market.FOLLOW_TO_BASKET)
        
    def remove_from_cart(self, index):
        self.click_element_by_index(Market.REMOVE_FROM_BASKET, index)